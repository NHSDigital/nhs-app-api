...
//    val availableAppointmentsPage = appointmentsBooking
//
//
...
//        var slots = availableAppointmentsPage.appointmentsBooking.getAllSlots()
//
...
//        val actualSlots = availableAppointmentsPage.appointmentsBooking.getAllSlots()
//
...
//        var message = availableAppointmentsPage.appointmentsBooking.getInformationMessage()
//        Assert.assertEquals("There are no appointmentsBooking available at the moment", message.findElement(By.cssSelector("h3")).text)
//    }
//
...
//        var actualSlots = availableAppointmentsPage.appointmentsBooking.getAllSlots()
//
//        Assert.assertArrayEquals(expectedSlots.toTypedArray(), actualSlots.toTypedArray())
//    }
//
