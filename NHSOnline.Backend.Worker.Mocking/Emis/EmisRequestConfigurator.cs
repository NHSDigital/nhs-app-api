...
namespace NHSOnline.Backend.Worker.Mocking.Emis
{
    public static class EmisRequestConfigurator
    {
        ...
        {
            applicationId = applicationId ?? MockingClient.Configuration.EmisConfiguration.ApplicationId;
        ...
        {
            version = version ?? MockingClient.Configuration.EmisConfiguration.Version;
