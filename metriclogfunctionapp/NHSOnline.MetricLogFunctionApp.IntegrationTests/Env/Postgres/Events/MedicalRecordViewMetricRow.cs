...
INSERT INTO {tableName}(""Timestamp"", ""SessionId"", ""HasSummaryRecordAccess"", ""HasDetailedRecordAccess"", ""AuditId"")
VALUES(@Timestamp, @SessionId, @HasSummaryRecordAccess, @HasDetailedRecordAccess, @AuditId)
";
    }
}