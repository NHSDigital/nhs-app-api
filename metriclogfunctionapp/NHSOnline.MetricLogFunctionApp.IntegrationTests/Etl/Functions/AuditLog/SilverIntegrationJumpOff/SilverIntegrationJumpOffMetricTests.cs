...
namespace NHSOnline.MetricLogFunctionApp.IntegrationTests.Etl.Functions.AuditLog.SilverIntegrationJumpOff;

[TestClass]
public class SilverIntegrationJumpOffMetricTests
{
        ...
        private string _operation = "SilverIntegration_JumpOff_Click";
        private string _details = "The user has jumped off to an integration partner";
        private string _providerId = "ers";
        private string _providerName = "Electronic Referral Service";
        private string _jumpOffId = "manageYourReferral";


        private AuditRecord _record;
        private SilverIntegrationJumpOffMetricRow _expectation;
        ...
        public void Setup()
        {
            ...
            _expectation = new SilverIntegrationJumpOffMetricRow()
        ...
        [NhsAppTest]
        public async Task SilverIntegrationJumpOffMetric_IsLoaded(TestEnv env)
        {
            // Act
        ...
        [NhsAppTest]
        public async Task SilverIntegrationJumpOffMetric_WhenEventIsRepeated_DuplicatesNotLoaded(TestEnv env)
        {
            // Act
            var status = await AuditLogEtlTestHelper.CreateAndPostAuditRecord(env, _record);
            status.Should().Be(HttpStatusCode.OK);
        ...
        [NhsAppTest]
        public async Task SilverIntegrationJumpOffMetric_WhenRowExistsInDB_DuplicatesNotLoaded(TestEnv env)
        {
            // Stage
        ...
        [NhsAppTest]
        public async Task
            SilverIntegrationJumpOffMetric_AuditLogEventHubMessagesWithInvalidOperationField_AreNotLoaded(TestEnv env)
        {
            // Stage
        ...
        [NhsAppTest]
        public async Task SilverIntegrationJumpOffMetric_AuditLogEventHubMessagesWithInvalidDetailsField_AreNotLoaded(
            TestEnv env)
        {
            // Stage
