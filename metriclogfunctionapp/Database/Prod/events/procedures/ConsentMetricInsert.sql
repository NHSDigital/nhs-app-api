CREATE OR REPLACE PROCEDURE events.ConsentMetricInsert(
...
INSERT INTO "events"."ConsentMetric" (
        "Timestamp",
        "SessionId",
        "AuditId",
        "LoginId",
...
VALUES (
        ...
        loginId,
        proofLevel
    ) ON CONFLICT ON CONSTRAINT consentmetric_auditid_unique DO NOTHING;
