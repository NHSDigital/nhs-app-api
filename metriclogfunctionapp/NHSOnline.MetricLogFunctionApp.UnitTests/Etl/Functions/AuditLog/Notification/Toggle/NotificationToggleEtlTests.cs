...
{
    [TestClass]
    public class NotificationToggleEtlTests
    {
        private Mock<IEventsRepository> _repo;
        private Mock<IAuditLogParser<NotificationToggleMetric>> _parser;
        private NotificationToggleMetricEtl _etl;
        ...
        public void TestInitialize()
        {
            ...
            _parser = new Mock<IAuditLogParser<NotificationToggleMetric>>(MockBehavior.Strict);
            _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
            _etl = new NotificationToggleMetricEtl(_repo.Object, _parser.Object, _requestQueueOrchestrator.Object);
        }
        ...
        private static NotificationToggleMetric BuildMetric(
            string loginId,
            string timestamp,
            string optedIn,
            string auditId)
