...
namespace NHSOnline.MetricLogFunctionApp.UnitTests.Etl.Functions.AuditLog.Notification.Toggle
{
    [TestClass]
    public class NotificationToggleEventParserTests
    {
        protected NotificationToggleEventParser SystemUnderTest;

        [TestInitialize]
        public void Setup()
        {
            SystemUnderTest = new NotificationToggleEventParser();
        }
        ...
        public void Parse_ValidInputs_OtherFieldsSetCorrectly()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<NotificationToggleMetric>();
            ...
            parseResult.NotificationToggle.Should().Be("On");
        ...
        public void Parse_MissingNotificationToggleShouldBeOff()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<NotificationToggleMetric>();
            parseResult.NotificationToggle.Should().Be("Off");
        }

        private static AuditRecord BuildEvent(
            string operation = "NotificationToggle_Response",
            string details = "Notification toggled.",
            string notificationToggle = "true")
        {
            return new AuditRecord()
            {
                ...
                Operation = operation,
                Details = $"{details} optIn={notificationToggle}",
                ApiVersion = "Api-Test",
                WebVersion = "Web-Test",
