...
namespace NHSOnline.MetricLogFunctionApp.UnitTests.Etl.Functions.AuditLog.AppointmentCancel
{
    [TestClass]
    public class AppointmentCancelEventParserTests
    {
        protected AppointmentCancelEventParser SystemUnderTest;

        [TestInitialize]
        public void Setup()
        {
            SystemUnderTest = new AppointmentCancelEventParser();
        }
        ...
        public void Parse_ValidInputs_OtherFieldsSetCorrectly()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<AppointmentCancelMetric>();
        ...
        private static AuditRecord BuildEvent(
            string operation = "Appointments_Cancel_Response",
            string details = "Appointment successfully cancelled for appointment with id: 237710")
        {
