...
[TestClass]
public class MedicalRecordSectionViewEtlTests
{
    private Mock<IEventsRepository> _repo;
    private Mock<IAuditLogParser<MedicalRecordSectionViewMetric>> _parser;
    private MedicalRecordSectionViewMetricEtl _etl;
    ...
    public void TestInitialize()
    {
        ...
        _parser = new Mock<IAuditLogParser<MedicalRecordSectionViewMetric>>(MockBehavior.Strict);
        _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
        _etl = new MedicalRecordSectionViewMetricEtl(_repo.Object, _parser.Object,_requestQueueOrchestrator.Object);
    }
    ...
    private static MedicalRecordSectionViewMetric BuildMetric(
        string timestamp,
        string sessionId,
        string supplierId,
