...
namespace NHSOnline.MetricLogFunctionApp.UnitTests.Etl.Functions.AuditLog.NominatedPharmacy.Create
{
    ...
    {
        protected NominatedPharmacyCreateEventParser SystemUnderTest;

        [TestInitialize]
        public void Setup()
        {
            SystemUnderTest = new NominatedPharmacyCreateEventParser();
        }
        ...
        public void Parse_ValidInputs_OtherFieldsSetCorrectly()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<NominatedPharmacyCreateMetric>();
        ...
        private static AuditRecord BuildEvent(
            ...
            string details = "Successfully created new nominated pharmacy registration to Z0000")
        {
