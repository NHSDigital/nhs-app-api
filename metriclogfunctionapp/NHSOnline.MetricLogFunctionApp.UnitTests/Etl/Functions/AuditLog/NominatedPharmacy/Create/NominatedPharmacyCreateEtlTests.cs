...
namespace NHSOnline.MetricLogFunctionApp.UnitTests.Etl.Functions.AuditLog.NominatedPharmacy.Create
{
    [TestClass]
    public class NominatedPharmacyCreateEtlTests
    {
        private Mock<IEventsRepository> _repo;
        private Mock<IAuditLogParser<NominatedPharmacyCreateMetric>> _parser;
        private NominatedPharmacyCreateMetricEtl _etl;
        ...
        public void TestInitialize()
        {
            ...
            _parser = new Mock<IAuditLogParser<NominatedPharmacyCreateMetric>>(MockBehavior.Strict);
            _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
            _etl = new NominatedPharmacyCreateMetricEtl(_repo.Object, _parser.Object, _requestQueueOrchestrator.Object);
        }
        ...
        private static NominatedPharmacyCreateMetric BuildMetric(
            string timestamp,
            string sessionId,
            string auditId)
        {
