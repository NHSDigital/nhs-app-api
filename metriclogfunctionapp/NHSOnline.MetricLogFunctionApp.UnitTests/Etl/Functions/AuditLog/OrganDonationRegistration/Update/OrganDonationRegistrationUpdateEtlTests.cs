...
{
    [TestClass]
    public class OrganDonationRegistrationUpdateEtlTests
    {
        private Mock<IEventsRepository> _repo;
        private Mock<IAuditLogParser<OrganDonationRegistrationUpdateMetric>> _parser;
        private OrganDonationRegistrationUpdateMetricEtl _etl;
        ...
        public void TestInitialize()
        {
            ...
            _parser = new Mock<IAuditLogParser<OrganDonationRegistrationUpdateMetric>>(MockBehavior.Strict);
            _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
            _etl = new OrganDonationRegistrationUpdateMetricEtl(_repo.Object, _parser.Object,_requestQueueOrchestrator.Object);
        }
        ...
        private static OrganDonationRegistrationUpdateMetric BuildMetric(
            string timestamp,
            string sessionId,
            string auditId)
        {
