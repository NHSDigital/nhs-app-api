...
[TestClass]
public class OrganDonationRegistrationGetEtlTests
{
    private Mock<IEventsRepository> _repo;
    private Mock<IAuditLogParser<OrganDonationRegistrationGetMetric>> _parser;
    private OrganDonationRegistrationGetMetricEtl _etl;
    ...
    public void TestInitialize()
    {
        ...
        _parser = new Mock<IAuditLogParser<OrganDonationRegistrationGetMetric>>(MockBehavior.Strict);
        _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
        _etl = new OrganDonationRegistrationGetMetricEtl(_repo.Object, _parser.Object,_requestQueueOrchestrator.Object);
    }
        ...
        eventsIds.ForEach(id =>
            _repo.Verify(r =>
                r.CallStoredProcedure(
                    "CALL events.OrganDonationRegistrationGetMetricInsert({0},{1},{2})",
                    new object[]
                    {
    ...
    private static OrganDonationRegistrationGetMetric BuildMetric(
        string timestamp,
        string sessionId,
        string auditId)
    {
