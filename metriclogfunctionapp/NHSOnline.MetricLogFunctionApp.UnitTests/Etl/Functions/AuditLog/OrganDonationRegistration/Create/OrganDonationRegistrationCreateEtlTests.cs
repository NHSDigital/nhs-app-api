...
namespace NHSOnline.MetricLogFunctionApp.UnitTests.Etl.Functions.AuditLog.OrganDonationRegistration.Create
{
    [TestClass]
    public class OrganDonationRegistrationCreateEtlTests
    {
        private Mock<IEventsRepository> _repo;
        private Mock<IAuditLogParser<OrganDonationRegistrationCreateMetric>> _parser;
        private OrganDonationRegistrationCreateMetricEtl _etl;
        ...
        public void TestInitialize()
        {
            ...
            _parser = new Mock<IAuditLogParser<OrganDonationRegistrationCreateMetric>>(MockBehavior.Strict);
            _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
            _etl = new OrganDonationRegistrationCreateMetricEtl(_repo.Object, _parser.Object,_requestQueueOrchestrator.Object);
        }
        ...
        private static OrganDonationRegistrationCreateMetric BuildMetric(
            string timestamp,
            string sessionId,
            string auditId)
        {
