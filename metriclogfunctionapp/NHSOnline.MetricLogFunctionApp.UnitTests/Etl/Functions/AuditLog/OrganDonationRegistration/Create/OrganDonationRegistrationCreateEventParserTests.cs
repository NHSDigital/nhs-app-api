...
{
    [TestClass]
    public class OrganDonationRegistrationCreateEventParserTests
    {
        protected OrganDonationRegistrationCreateEventParser SystemUnderTest;

        [TestInitialize]
        public void Setup()
        {
            SystemUnderTest = new OrganDonationRegistrationCreateEventParser();
        }
        ...
        public void Parse_ValidInputs_OtherFieldsSetCorrectly()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<OrganDonationRegistrationCreateMetric>();
        ...
        private static AuditRecord BuildEvent(
            string operation = "OrganDonation_Registration_Response",
            string details = "The organ donation decision has been successfully registered")
        {
