...
{
    [TestClass]
    public class OrganDonationRegistrationWithdrawEventParserTests
    {
        protected OrganDonationRegistrationWithdrawEventParser SystemUnderTest;

        [TestInitialize]
        public void Setup()
        {
            SystemUnderTest = new OrganDonationRegistrationWithdrawEventParser();
        }
        ...
        public void Parse_ValidInputs_OtherFieldsSetCorrectly()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<OrganDonationRegistrationWithdrawMetric>();
        ...
        private static AuditRecord BuildEvent(
            string operation = "OrganDonation_Withdraw_Response",
            string details = "The organ donation decision has been successfully Withdrawn")
        {
