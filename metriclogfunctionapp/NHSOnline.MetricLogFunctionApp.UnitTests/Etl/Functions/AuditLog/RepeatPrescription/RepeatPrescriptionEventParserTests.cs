...
{
    [TestClass]
    public class RepeatPrescriptionEventParserTests
    {
        protected RepeatPrescriptionEventParser SystemUnderTest;

        [TestInitialize]
        public void Setup()
        {
            SystemUnderTest = new RepeatPrescriptionEventParser();
        }
        ...
        public void Parse_ValidInputs_OtherFieldsSetCorrectly()
        {
            ...
            // Assert
            parseResult.Should().BeOfType<RepeatPrescriptionMetric>();
        ...
        private static AuditRecord BuildEvent(
            string operation = "RepeatPrescriptions_OrderRepeatMedications_Response",
            string details = "Repeat prescription request successfully created")
        {
