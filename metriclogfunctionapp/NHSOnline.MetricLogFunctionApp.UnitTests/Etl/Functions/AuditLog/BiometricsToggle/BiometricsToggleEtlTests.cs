...
[TestClass]
public class BiometricsToggleEtlTests
{
    private Mock<IEventsRepository> _repo;
    private Mock<IAuditLogParser<BiometricsToggleMetric>> _parser;
    private BiometricsToggleMetricEtl _etl;
    ...
    public void TestInitialize()
    {
        ...
        _parser = new Mock<IAuditLogParser<BiometricsToggleMetric>>(MockBehavior.Strict);
        _requestQueueOrchestrator = new Mock<IRequestQueueOrchestrator<AuditReportRequest>>();
        _etl = new BiometricsToggleMetricEtl(_repo.Object, _parser.Object, _requestQueueOrchestrator.Object);
    }
    ...
    private static BiometricsToggleMetric BuildMetric(
        string sessionId,
        string timestamp,
        string optedIn,
        string auditId)
