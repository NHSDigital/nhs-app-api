...
const thirdPartyProvider = {
  ...
  pkb: {
    ...
    testResultsCie: {
      acceptablePathsRegex: '^\\/nhs-login\\/login\\?phrPath=\\/pkbNhsResultsMenu\\.action&brand=cie$',
      jumpOffId: 'testResultsCie',
      redirectPath: '/nhs-login/login?phrPath=%2FpkbNhsResultsMenu.action&brand=cie',
      provider: 'pkbCie',
    ...
    testResultsPkbSecondaryCare: {
      acceptablePathsRegex: '^\\/nhs-login\\/login\\?phrPath=\\/pkbNhsResultsMenu\\.action&brand=pkbSecondaryCare$',
      jumpOffId: 'testResultsPkbSecondaryCare',
      redirectPath: '/nhs-login/login?phrPath=%2FpkbNhsResultsMenu.action&brand=pkbSecondaryCare',
      provider: 'pkbSecondaryCare',
      serviceType: 'testResults',
    },
    ...
    testResultsPkbMyCareView: {
      acceptablePathsRegex: '^\\/nhs-login\\/login\\?phrPath=\\/pkbNhsResultsMenu\\.action&brand=pkbMyCareView$',
      jumpOffId: 'testResultsPkbMyCareView',
      redirectPath: '/nhs-login/login?phrPath=%2FpkbNhsResultsMenu.action&brand=pkbMyCareView',
      provider: 'pkbMyCareView',
      serviceType: 'testResults',
    },
