export default {
  ...
  nominatedPharmacyOnlineOnlySearch: {
    inputLabelText: 'Enter the name of the online-only pharmacy',
    searchButton: 'Search',
    errorMessageHeader: 'There\'s a problem',
  ...
  prescriptions: {
    ...
    confirm_prescription_details: {
      errors: {
        ...
        retryButtonText: 'Back to your repeat prescriptions',
        466: {
  ...
  nominated_pharmacy: {
    ...
    changeSuccess: {
      ...
      highStreetPrescription: 'Your prescriptions will now be sent to {pharmacyName} from now on.',
      ...
      registrationWarning: 'You may need to register with {pharmacyName} separately at {pharmacyUrl}',
  ...
  pageHeaders: {
    ...
    appointmentCancellingSuccess: 'Your appointment has been cancelled',
  ...
  shared: {
    organDonation: {
      recordDecision: 'Record Your organ donation decision',
    },
  },
  symptomBanner: {
  ...
  coronaVirus: {
    ...
    listItem1: 'you’ve been to mainland China, Hong Kong, Japan, Macau, Malaysia, Republic ' +
      'of Korea, Singapore, Taiwan, or Thailand and have become unwell ' +
      'within 2 weeks of returning, or',
