export default {
  ...
  proofLevelUpliftBanner: {
    ...
    description: {
      default: 'You\'ll need to prove who you are before you can get your COVID Pass for travel, book appointments, order repeat prescriptions, and view your health records in the NHS App.',
