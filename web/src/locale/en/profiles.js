export default {
  ...
  servicesYouCanAccessForName: 'Services you can access for {fullName}',
  switchToMyProfile: 'Switch to my profile',
  switchToNamesProfile: 'Switch to {givenName}\'s profile',
  switchToThisProfile: 'Switch to this profile',
