...
export default {
  ...
  wayfinderHelp: {
    referralsOrAppointmentsHelp: {
      ...
      changeNotShowingHelpText: 'You may have requested to change or cancel a referral or appointment.',
      changeNeedApprovalHelpText: 'Any updates you have made may not be shown until the request is approved by the relevant organisation or healthcare provider.',
    },
    confirmedAppointmentsHelp: {
      ...
      under18HelpText: 'If you\'re aged 16 to 17, you may not be able to view or manage some of your hospital appointments. This is because some NHS Trusts require you to be aged 18 or over to access these appointments.',
      changeNotShowingHelpTitle: 'If a change or cancellation is not showing',
      changeNotShowingHelpText: 'You may have requested to change or cancel a booked appointment.',
      changeNeedApprovalHelpText: 'Any updates you have made may not be shown until the request is approved by the healthcare provider the appointment is booked with.',
    },
