export default {
  ...
  authReturn: {
    ...
    ifYouStillCannotLogIn: 'If you still cannot log in, try again later.',
    otherServicesYouCanUse: 'Other services you can use',
    getYourCovidPassOnline: 'Get your NHS COVID Pass online',
    getMedicalAdvice: 'Get medical advice',
    goBackAndTryAgainLink: 'Go back and try logging in again',
    ifYouNeedToBookOrGetPrescription: 'If you need to book an appointment or get a prescription now, use your GP surgery\'s website or call the surgery directly.',
    forUrgentMedicalAdviceGoTo111OrCall111: {
      text: 'For urgent medical advice, go to 111.nhs.uk or call 111',
      label: 'For urgent medical advice, go to one one one dot nhs dot uk or call one one one',
    },
