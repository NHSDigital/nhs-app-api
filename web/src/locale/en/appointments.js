export default {
  ...
  book: {
    ...
    ifItIsUrgent: 'If it\'s urgent and you do not know what to do, call 111 to get help near you.',
    location: 'Location',
    ...
    today: 'Today',
    tomorrow: 'Tomorrow',
    tryToFilterAppointments: 'Try to filter appointments by a different period or select "No preference" for the practice member. If you cannot find the appointment you need, call your GP surgery.',
