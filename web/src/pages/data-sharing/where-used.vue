    ...
    <div class="nhsuk-grid-row">
      <div class="nhsuk-grid-column-full">
        ...
        <pagination :previous-link="overviewPath"
                    ...
                    :next-link="doesNotApplyPath"
                    next-title="When your choice does not apply" />
      </div>
    </div>
  </div>
</template>
...
import { DATA_SHARING_DOES_NOT_APPLY, DATA_SHARING_OVERVIEW } from '@/lib/routes';
...
export default {
  ...
  data() {
    return {
      ...
      overviewPath: DATA_SHARING_OVERVIEW.path,
    };
  },
};
</script>
