...
export const ACCOUNT = {
  ...
  meta: {
    headerKey: 'pageHeaders.settings',
...
export const ACCOUNT_COOKIES = {
  ...
  meta: {
    headerKey: 'pageHeaders.cookies',
    titleKey: 'pageTitles.cookies',
    proofLevel: proofLevel.P5,
...
export const ACCOUNT_NOTIFICATIONS = {
  ...
  meta: {
    headerKey: 'pageHeaders.notifications',
...
export const ACCOUNT_LOGIN_SETTINGS_INDEX = {
  ...
  meta: {
    headerKey: (store, i18n) => getLoginSettingsHeaderTitle('pageHeaders', store, i18n),
    titleKey: (store, i18n) => getLoginSettingsHeaderTitle('pageTitles', store, i18n),
    proofLevel: proofLevel.P5,
...
export const ACCOUNT_LOGIN_SETTINGS_ERROR = {
  ...
  meta: {
    headerKey: (store, i18n) => getLoginSettingsErrorHeaderTitle('pageHeaders', store, i18n),
    titleKey: (store, i18n) => getLoginSettingsErrorHeaderTitle('pageTitles', store, i18n),
    proofLevel: proofLevel.P5,
