...
/**
 * This is the API for NHS Online endpoints that are intended for CDS.
 * @class NhsOnlineApiCdsapi
...
class CDSApi {
  ...
  mergeQueryParams(parameters, queryParameters) {
     ...
     * HTTP Request
     * @method
     * @name NhsOnlineApiCdsapi#request
  ...
  /**
   * This call returns the first question in admin help.
   * @method
   * @name CDSApi#getFhirServiceDefinitionByProviderByServicedefinitionid
   * @param {object} parameters - method options and parameters
   */
  getFhirServiceDefinitionByProviderByServicedefinitionid(parameters) {
    ...
    let path = '/fhir/ServiceDefinition/:provider/:serviceDefinitionId';
    let body = {};
    let headers = {};
    let form = {};
    ...
    headers['Accept'] = ['application/json+fhir'];
        ...
        if (parameters['serviceDefinitionId'] !== undefined) {
          queryParameters['serviceDefinitionId'] = parameters['serviceDefinitionId'];
        }
   ...
   * This call returns the first question in admin help.
   * @method
   * @name CDSApi#postFhirServiceDefinitionByProviderByServicedefinitionidEvaluate
   * @param {object} parameters - method options and parameters
   */
  postFhirServiceDefinitionByProviderByServicedefinitionidEvaluate(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let ignoreError = parameters.ignoreError || false;
    let deferred = $q.defer();
    let domain = this.domain;
    let path = '/fhir/ServiceDefinition/:provider/:serviceDefinitionId/$evaluate';
    let body = {};
    let headers = {};
    let form = {};
    ...
    headers['Content-Type'] = ['application/json+fhir'];
      ...
      /**
   * This call will return the service definitions for the provider eConsult
   * @method
   * @name CDSApi#getFhirServiceDefinitionByProvider
   * @param {object} parameters - method options and parameters
   */
  getFhirServiceDefinitionByProvider(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let ignoreError = parameters.ignoreError || false;
