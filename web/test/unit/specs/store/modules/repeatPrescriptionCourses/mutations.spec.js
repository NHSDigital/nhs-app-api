import mutations from '@/store/modules/repeatPrescriptionCourses/mutations';
import { REPEAT_PRESCRIPTION_COURSES_LOADED, REPEAT_PRESCRIPTION_UPDATE_ADDITIONAL_INFO } from '@/store/modules/repeatPrescriptionCourses/mutation-types';
