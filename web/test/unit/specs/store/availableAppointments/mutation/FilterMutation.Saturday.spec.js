...
describe('FilterMutation [Saturday]', () => {
  const fakeDateProvider = {
    create: (date = new Date('2018-08-18 17:23:18')) => DateProvider.create(date),
  };
  ...
  each([
    [
      ...
      [
        ['2018-08-18', [data.slot1, data.slot2, data.slot9]],
      ],
    ],
    [
      {
      ...
      [
        ['2018-08-18', [data.slot1, data.slot2]],
      ],
    ],
    [
      {
  ...
  each([
    [
      ...
      [
        ['2018-08-19', [data.slot3, data.slot4, data.slot11]],
      ],
    ],
    [
      {
