...
describe('FilterMutation [Sunday]', () => {
  const fakeDateProvider = {
    create: (date = new Date('2018-08-19')) => DateProvider.create(date),
  };
  ...
  each([
    [
      ...
      [
        ['2018-08-19', [data.slot12, data.slot14]],
      ],
    ],
    [
      {
      ...
      [
        ['2018-08-19', [data.slot14, data.slot11, data.slot2, data.slot13, data.slot1, data.slot18]],
      ],
    ],
    [
      {
      ...
      [
        ['2018-08-19', [data.slot12, data.slot14, data.slot2]],
      ],
    ],
    [
      {
  ...
  each([
    [
      ...
      [
        ['2018-08-20', [data.slot5, data.slot4]],
      ],
    ],
    [
      {
      ...
      [
        ['2018-08-20', [data.slot5, data.slot3, data.slot4, data.slot15]],
      ],
    ],
    [
      {
      ...
      [
        ['2018-08-20', [data.slot3, data.slot4, data.slot15]],
      ],
    ],
    [
      {
