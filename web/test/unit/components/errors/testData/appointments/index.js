...
export default {
  400: [
    PATH,
    {
      ...
      messageLabel: 'Try again later. If the problem continues and you need this information now, contact your GP surgery directly. For urgent medical advice, call one one one.',
  ...
  504: [
    PATH,
    {
      ...
      messageLabel: 'Try again now. If the problem continues and you need this information now, contact your GP surgery directly. For urgent medical advice, call one one one.',
      hasRetryButton: true,
