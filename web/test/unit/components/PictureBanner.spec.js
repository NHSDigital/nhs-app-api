...
describe('PictureBanner.vue', () => {
  ...
  describe('props data for non proxy', () => {
    describe('Name does have value', () => {
      beforeEach(() => {
        wrapper = mountPictureBanner({ displayName: 'name', nhsNumber: '123456789', age: undefined, practice: undefined });
      });
  ...
  describe('props data for proxy', () => {
    describe('Name does have value', () => {
      beforeEach(() => {
        wrapper = mountPictureBanner({ displayName: 'name', nhsNumber: undefined, age: '21', practice: 'surgery' });
      });
