...
{
    public class NhsLoginReauthorizeSSOBehaviour : INhsLoginSSOBehaviour
    {
        ...
        {
            return Task.FromResult<IActionResult>(new RedirectResult($"authorize?state={state}&scope={scope}&redirect_uri={redirectUri}"));
        }
    }
}