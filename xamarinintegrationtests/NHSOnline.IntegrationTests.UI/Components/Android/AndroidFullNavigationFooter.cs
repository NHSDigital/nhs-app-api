...
namespace NHSOnline.IntegrationTests.UI.Components.Android
{
    public class AndroidFullNavigationFooter
    {
        ...
        private AndroidFullNavigationFooter(IAndroidInteractor interactor)
            => _interactor = interactor;

        public static AndroidFullNavigationFooter Create(IAndroidInteractor interactor)
            => new AndroidFullNavigationFooter(interactor);
