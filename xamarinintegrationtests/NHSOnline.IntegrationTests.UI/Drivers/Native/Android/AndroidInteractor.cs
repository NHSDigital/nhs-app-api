...
namespace NHSOnline.IntegrationTests.UI.Drivers.Native.Android
{
    class AndroidInteractor : IAndroidInteractor
    {
        ...
        public AndroidInteractor(NativeDriverContext nativeDriverContext,
        ...
        void IInteractor<AndroidDriver<AndroidElement>, AndroidElement>.ActOnElementContext(By by, Action<ElementContext<AndroidDriver<AndroidElement>, AndroidElement>> action)
        {
