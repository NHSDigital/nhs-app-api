namespace NHSOnline.IntegrationTests.WebIntegration.Pkb
{
    public static class PhrPath
    {
        ...
        public const string RecordSharing = "/patient/myConsentTeam.action?tab=invitations&subTab=myClinicians";
        public const string SharedHealthLinks = "/library/manageLibrary.action";
        public const string TestResultsAndImaging = "/pkbNhsResultsMenu.action";
