...
namespace NHSOnline.IntegrationTests.WebIntegration.TestProvider
{
    ...
    {
        [Ignore("NHSO-16677: Raised to address the session not extending issue and address this test appearing flakey")]
        [NhsAppAndroidTest]
        ...
        // Tests split to reduce pipeline failures whilst NHSO-16677 is resolved.
        // This test should be removed in favour of the above tests when that ticket is completed.
        [NhsAppAndroidTest]
        public void APatientCanNavigateOnThirdPartiesThatUseTheGoToPageMethodSet1Android(IAndroidDriverWrapper driver)
        {
            var patient = new EmisPatient()
                .WithName(b => b.GivenName("Brie").FamilyName("Oche"));
        ...
        // This test should be removed in favour of the above tests when that ticket is completed.
        [NhsAppAndroidTest]
        public void APatientCanNavigateOnThirdPartiesThatUseTheGoToPageMethodSet2Android(IAndroidDriverWrapper driver)
        {
            var patient = new EmisPatient()
                .WithName(b => b.GivenName("Brie").FamilyName("Oche"));
        ...
        // This test should be removed in favour of the above tests when that ticket is completed.
        [NhsAppIOSTest]
        public void APatientCanNavigateOnThirdPartiesThatUseTheGoToPageMethodSet1IOS(IIOSDriverWrapper driver)
        {
            var patient = new PkbPatient()
                .WithName(b => b.GivenName("Fo").FamilyName("Catcha"));
        ...
        // This test should be removed in favour of the above tests when that ticket is completed
        [NhsAppIOSTest]
        public void APatientCanNavigateOnThirdPartiesThatUseTheGoToPageMethodSet2IOS(IIOSDriverWrapper driver)
        {
            var patient = new PkbPatient()
                .WithName(b => b.GivenName("Fo").FamilyName("Catcha"));
