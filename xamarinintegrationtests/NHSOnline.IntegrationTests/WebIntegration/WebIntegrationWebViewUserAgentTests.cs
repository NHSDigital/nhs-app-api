...
{
    [TestClass]
    public class WebIntegrationWebViewUserAgentTests
    {
        [NhsAppAndroidTest]
        public void APatientCanAccessAWebIntegrationAndTheWebViewUserAgentIsSetAndroid(IAndroidDriverWrapper driver)
        {
        ...
        [NhsAppIOSTest]
        public void APatientCanAccessAWebIntegrationAndTheWebViewUserAgentIsSetIOS(IIOSDriverWrapper driver)
        {
            var patient = new EmisPatient()
                .WithName(b => b.GivenName("Terry").FamilyName("Tibbs"));
            using var patients = Mocks.Patients.Add(patient);
