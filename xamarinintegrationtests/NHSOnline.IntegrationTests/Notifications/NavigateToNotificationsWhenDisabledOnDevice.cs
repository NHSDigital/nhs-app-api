...
{
    [TestClass]
    [BusinessRule("BR-SET-04.9", "Navigating to notification settings when notifications have been disabled for the device in the device settings displays an error message")]
