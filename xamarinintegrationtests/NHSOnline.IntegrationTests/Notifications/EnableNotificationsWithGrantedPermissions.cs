...
{
    [TestClass]
    [BusinessRule("BR-SET-04.6", "Enabling notifications when permissions have previously been granted on the device successfully enables notifications for the device")]
