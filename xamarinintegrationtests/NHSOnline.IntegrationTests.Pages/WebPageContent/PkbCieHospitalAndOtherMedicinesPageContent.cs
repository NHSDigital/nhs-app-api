...
{
    public class PkbCieHospitalAndOtherMedicinesPageContent
    {
        private readonly IWebInteractor _interactor;

        internal PkbCieHospitalAndOtherMedicinesPageContent(IWebInteractor interactor) => _interactor = interactor;
        ...
        private WebText TitleText => WebText.WithTagAndText(
            _interactor,
            "h1",
            "Hospital and other medicines This service is provided by Care Information Exchange powered by Patients Know Best");
