...
{
    public class PkbHospitalAndOtherPrescriptionsPageContent
    {
        private readonly IWebInteractor _interactor;

        internal PkbHospitalAndOtherPrescriptionsPageContent(IWebInteractor interactor) => _interactor = interactor;
