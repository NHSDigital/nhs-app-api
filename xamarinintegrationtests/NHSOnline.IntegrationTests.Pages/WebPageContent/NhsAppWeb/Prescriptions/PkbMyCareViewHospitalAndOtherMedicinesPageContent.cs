...
{
    public class PkbMyCareViewHospitalAndOtherMedicinesPageContent
    {
        private readonly IWebInteractor _interactor;

        internal PkbMyCareViewHospitalAndOtherMedicinesPageContent(IWebInteractor interactor) => _interactor = interactor;
        ...
        private WebText TitleText => WebText.WithTagAndText(
            _interactor,
            "h1",
            "Hospital and other medicines This service is provided by MyCareView powered by Patients Know Best");
