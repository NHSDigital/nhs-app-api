...
{
    public class AndroidPkbHospitalAndOtherPrescriptionsPage
    {
        private readonly IAndroidDriverWrapper _driver;

        private AndroidFullNavigation Navigation { get; }

        private PkbHospitalAndOtherPrescriptionsPageContent PageContent { get; }

        private AndroidPkbHospitalAndOtherPrescriptionsPage(IAndroidDriverWrapper driver)
        {
            _driver = driver;
            Navigation = new AndroidFullNavigation(driver);
            PageContent = new PkbHospitalAndOtherPrescriptionsPageContent(driver.Web.NhsAppLoggedInWebView());
        }

        public static AndroidPkbHospitalAndOtherPrescriptionsPage AssertOnPage(IAndroidDriverWrapper driver)
        {
            var page = new AndroidPkbHospitalAndOtherPrescriptionsPage(driver);
