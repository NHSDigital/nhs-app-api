...
{
    public class AndroidYourHealthSecondaryCareViewPage
    {
        private readonly IAndroidDriverWrapper _driver;

        private AndroidYourHealthSecondaryCareViewPage(IAndroidDriverWrapper driver)
        {
            _driver = driver;
            Navigation = new AndroidFullNavigation(driver);
            PageContent = new YourHealthSecondaryCareViewPageContent(driver.Web.NhsAppLoggedInWebView());
        }

        private AndroidFullNavigation Navigation { get; }

        public YourHealthSecondaryCareViewPageContent PageContent { get; }

        public static AndroidYourHealthSecondaryCareViewPage AssertOnPage(IAndroidDriverWrapper driver)
        {
            var page = new AndroidYourHealthSecondaryCareViewPage(driver);
        ...
        public AndroidYourHealthSecondaryCareViewPage TabIntoFocus()
        {
