#! /usr/bin/env bash
export IMAGE_NAMES=(nhsonline-web nhsonline-backendpfsapi nhsonline-backendcidapi nhsonline-backendservicejourneyrulesapi nhsonline-backendusersapi nhsonline-backenduserinfoapi)
export IMAGE_SETTING_NAMES=(WEB PFSAPI CIDAPI SJRCONFIG SJRAPI USERSAPI USERINFOAPI)
