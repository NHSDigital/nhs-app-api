...
namespace NHSOnline.Backend.Worker.UnitTests.Suppliers.Emis
{
    ...
    public class EmisIm1ConnectionServiceTests
    {
        ...
        private EmisIm1ConnectionService _sut;
        ...
        public void TestInitialize()
        {
            ...
            _sut = _fixture.Create<EmisIm1ConnectionService>();
        }
        ...
        public async Task Verify_ReturnsAConnection_WhenRequested()
        {
            ...
            var sut = new EmisIm1ConnectionService(emisClientMock.Object);

            var result = await sut.Verify(DefaultConnectionToken, DefaultOdsCode);
        ...
        public async Task Register_ReturnsAccountAlreadyExists_WhenEmisClientMeApplicationsReturnsSpecificErrorMessage()
        {
            ...
            errorResponse.Exceptions.First().Message = EmisApiErrorMessages.MeApplicationsPost_AlreadyLinked;
