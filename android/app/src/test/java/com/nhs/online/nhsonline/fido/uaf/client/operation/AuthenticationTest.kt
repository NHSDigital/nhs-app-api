...
import com.nhs.online.nhsonline.fido.uaf.msg.AuthenticationRequest
...
class AuthenticationTest {
    ...
    fun setup() {
        ...
        mockAuthenticationCall = mock {
            on { getUafMessageRequest(any(), anyBoolean()) } doReturn "{}"
        }
        ...
        auth = Authentication(fidoEndpointConfig, mockAuthenticationCall)
