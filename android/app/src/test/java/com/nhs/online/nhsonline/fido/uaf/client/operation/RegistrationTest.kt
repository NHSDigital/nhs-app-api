...
import com.nhs.online.nhsonline.fido.uaf.SampleCert
...
import com.nhs.online.nhsonline.fido.uaf.crypto.FidoSigner
...
class RegistrationTest {
    ...
    fun setup() {
        ...
        mockRegistrationCall = mock {
            on { getUafRegistrationMessage(any(), any()) } doReturn "{}"
        }
        ...
        registration =
                Registration(fidoEndpointConfig, mockRegistrationCall)
    ...
    fun requestUafRegistrationMsg_ReturnsNonEmptyRegMessage() {
        ...
        val uafRegMsg = registration.requestUafRegistrationMessage(facetId!!, "accessToken")
    ...
    @Test
    fun requestUafRegistrationMsg_ReturnsNonEmptyRegMessage_PreSDK_28() {
