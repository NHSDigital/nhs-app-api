...
class Registration(
    private val endpointConfig: FidoEndpointConfig,
    ...
    fun requestUafRegistrationMessage(facetId: String, accessToken: String): String {
        val uafRegistrationMessage =
            registrationCall.getUafRegistrationMessage(accessToken, facetId)
