...
import com.nhs.online.nhsonline.fido.uaf.msg.TrustedFacetsList
import com.nhs.online.nhsonline.fido.uaf.msg.Version
        ...
        try {
            ...
            if (appID == null || appID.isEmpty()) {
                ...
                if (facetId != appID) {
                    ...
                    if (!facetFound) {
                        return Fido.EMPTY_UAF_RESPONSE_MESSAGE
                    }
                }
            }
            if (isTransaction) {
            ...
            uafMessage.put(Fido.UAF_AUTH_RESPONSE_FIELD, requestArray.toString())
            return uafMessage.toString()
        } catch (e: JSONException) {
            e.printStackTrace()
            return if (serverResponse.contains(Fido.CONNECTION_ERROR_CODE_KV))
                serverResponse else
                Fido.EMPTY_UAF_RESPONSE_MESSAGE
        }
    }
