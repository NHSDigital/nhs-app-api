...
class Application : Application() {
    ...
    private fun setLocale() {
        val textToSpeech = TextToSpeech(this, null)

        // Note we are specifying a language, and a region, the variant doesn't matter.
        val locale = Locale(resources.getString(R.string.locale_language),
            resources.getString(R.string.locale_region))
