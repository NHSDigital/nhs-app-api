...
package com.nhs.online.nhsonline.fido.uaf.client

import android.util.Log
import com.nhs.online.nhsonline.fido.Fido
import com.nhs.online.nhsonline.fido.uaf.crypto.Base64url
import com.nhs.online.nhsonline.fido.uaf.crypto.KeyCodec
import com.nhs.online.nhsonline.fido.uaf.crypto.SHA
import com.nhs.online.nhsonline.fido.uaf.msg.RegistrationResponse
import com.nhs.online.nhsonline.fido.uaf.tlv.AlgAndEncodingEnum
import com.nhs.online.nhsonline.fido.uaf.tlv.TagsEnum
import com.nhs.online.nhsonline.fido.uaf.tlv.TlvAssertionParser
import com.nhs.online.nhsonline.fido.uaf.tlv.UnsignedUtil.encodeInt
...
class RegAssertionBuilder(
    ...
    private val aaid: ByteArray
        ...
        get() {
            val byteout = ByteArrayOutputStream()
            val value = Fido.AAID.toByteArray()
            byteout.write(value)
            return byteout.toByteArray()
        }
    ...
    private fun getFinalChallengeParameters(response: RegistrationResponse): ByteArray {
        return SHA.sha(response.fcParams.toByteArray(), Fido.ALGORITHM_SHA256)
    }
