...
class AuthReturnPage : HybridPageObject(Companion.PageType.WEBVIEW_APP) {
    ...
    val errorParagraph2 = "If the problem continues and you need to book an appointment or get a prescription now, contact your GP surgery directly. For urgent medical advice, call 111."
