...
open class OrganDonationFaithAndBeliefsPage : OrganDonationBasePage() {
    ...
    private fun assertInformation() {
        OrganDonationDetailsAssertor("Why they matter for organ donation", this)
                .assert("When organ donation is a possibility, NHS staff will always speak to a donor's family " +
                        "about the donor's decision, medical history, and anything else that would be relevant to " +
                        "organ donation.")
                .assert("We recognise that for some people, this will include their faith or beliefs and they would " +
                        "want organ donation to go ahead in a way that is in line with their beliefs or customs.")
        OrganDonationDetailsAssertor("What we can do to help", this)
                .assert("Let us know if you want your faith and beliefs to be a part of " +
    ...
    private var questionContent = "Would you like NHS staff to speak to your family (and anyone else appropriate) " +
