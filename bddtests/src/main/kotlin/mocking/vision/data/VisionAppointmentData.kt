...
class VisionAppointmentData private constructor() : BaseAppointmentData() {

    val timeZone = TimeZone.getTimeZone("Europe/London")
    override val dateTimeFormat = createTppDateTimeFormat()
    override val defaultPatient = Patient.getDefault("Vision")
    ...
    private class AppointmentDataHolder {
        private var instance: VisionAppointmentData? = null

        fun getInstance(): VisionAppointmentData {
            if (instance == null) {
                val newInstance = VisionAppointmentData()
                instance = newInstance
            }
            return instance as VisionAppointmentData
        }
    }
