...
const val DEFAULT_TIME_HOUR = 14
const val DEFAULT_TIME_MIN = 10
const val ALTERNATE_DEFAULT_TIME_HOUR = 15
const val ALTERNATE_DEFAULT_TIME_MIN = 20
...
const val SIXTEEN_WEEKS_IN_DAYS = DAYS_IN_WEEK * 16
...
open class AppointmentsSlotsExample {
    ...
    private val nextSixteenWeeksDate = LocalDateTime.now().plusDays(SIXTEEN_WEEKS_IN_DAYS)
    ...
    private val startDateNextSixteenWeeksAppointment1 = AppointmentDate(
            nextSixteenWeeksDate,
            DEFAULT_TIME_HOUR,
            DEFAULT_TIME_MIN
    )

    val historicalDate = AppointmentDate(LocalDateTime.now().minusMonths(MONTHS_IN_HALF_YEAR),
    ...
    val defaultSessionDetails = AppointmentSessionFacadeBuilder()
    ...
    fun getGenericExampleBuilder(appointmentSessionFacade: ArrayList<AppointmentSessionFacade>? = null)
    ...
    fun multipleSlotsOneLocation(): AppointmentSlotsResponseFacade {
        ...
        val appointmentSessions = generateAppointmentData.generateAppointments(
                ...
                dates = arrayListOf(
                        ...
                        startDateNextSixteenWeeksAppointment1)
        )
