...
class ViewSpinePdsStubs(private val mockingClient: MockingClient) {
    ...
    fun getResponseWithoutP1(odsCode: String): String {
        return """
            <?xml version='1.0' encoding='UTF-8'?>
            <SOAP-ENV:Envelope
              xmlns:crs="http://national.carerecords.nhs.uk/schema/crs/"
              ...
              xmlns:hl7="urn:hl7-org:v3">
              <SOAP-ENV:Header>
                <wsa:MessageID>uuid:60DE5AFC-5CFE-11E9-9D22-F4034348F02E</wsa:MessageID>
                <wsa:Action>urn:nhs:names:services:pdsquery/QUPA_IN000009UK03</wsa:Action>
                <wsa:To>${IP}</wsa:To>
                <wsa:From>
                  <wsa:Address>https://192.168.128.11/sync-service</wsa:Address>
              ...
              <SOAP-ENV:Body>
                <retrievalQueryResponse>
                  <QUPA_IN000009UK03>
                    <id root="60DE5AFC-5CFE-11E9-9D22-F4034348F02E"/>
                    <creationTime value="20190412083842"/>
                    <versionCode code="3NPfIT6.3.01"/>
                    <interactionId root="2.16.840.1.113883.2.1.3.2.4.12" extension="QUPA_IN000009UK03"/>
                    <processingCode code="P"/>
                    <processingModeCode code="T"/>
                    ...
                    <acknowledgement typeCode="AA">
                      <messageRef>
                        <id root="86bc0f46-f8b9-4ffd-8042-cbb6b054fc2d"/>
                      </messageRef>
                    </acknowledgement>
                    <communicationFunctionRcv typeCode="RCV">
                      <device classCode="DEV" determinerCode="INSTANCE">
                    ...
                    <ControlActEvent classCode="CACT" moodCode="EVN">
                      ...
                      <subject typeCode="SUBJ">
                        <PDSResponse
                          ...
                          <subject typeCode="SBJ">
                            <patientRole classCode="PAT">
                              <id root="2.16.840.1.113883.2.1.4.1" extension="9674998470"/>
                              <patientPerson classCode="PSN" determinerCode="INSTANCE">
                                <administrativeGenderCode code="1"/>
                                <birthTime value="19460830"/>
                                <playedOtherProviderPatient classCode="PAT">
                                  <subjectOf typeCode="SBJ">
                                    <patientCareProvisionEvent classCode="PCPR" moodCode="EVN">
                                      <code codeSystem="2.16.840.1.113883.2.1.3.2.4.17.37" code="1"/>
                                      ...
                                      <id root="2.16.840.1.113883.2.1.3.2.4.18.1" extension="uMABr"/>
                                      <performer typeCode="PRF">
                                        <assignedEntity classCode="ASSIGNED">
                                          <id root="2.16.840.1.113883.2.1.4.3" extension="${odsCode}"/>
                                        </assignedEntity>
                                ...
                                <COCT_MT000201UK02.PartOfWhole classCode="PART">
                                  <addr use="H">
                                    <streetAddressLine>FLAT B</streetAddressLine>
                                    <streetAddressLine>8 RUSSELL STREET</streetAddressLine>
                                    <streetAddressLine/>
                                    <streetAddressLine>LONDON</streetAddressLine>
                                    <streetAddressLine/>
                                    <postalCode>WC2B 5HZ</postalCode>
                                    <useablePeriod>
                                      <low value="20091130"/>
                                    </useablePeriod>
                                    <id root="2.16.840.1.113883.2.1.3.2.4.18.1" extension="YCIQQ"/>
                                  </addr>
                                </COCT_MT000201UK02.PartOfWhole>
                                <COCT_MT000203UK02.PartOfWhole classCode="PART">
                                  <partPerson classCode="PSN" determinerCode="INSTANCE">
                                    <name use="L">
                                      ...
                                      <given>Irving</given>
                                      <given>Horton</given>
                                      <family>GODREY</family>
                                      <validTime>
                                        <low value="19701006"/>
                                      </validTime>
                                      <id root="2.16.840.1.113883.2.1.3.2.4.18.1" extension="JksPy"/>
                                    </name>
                                  </partPerson>
                                </COCT_MT000203UK02.PartOfWhole>
                              </patientPerson>
