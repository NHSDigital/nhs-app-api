...
@appointment-accessibility
  Feature: Appointment accessibility
    ...
    Scenario: The MyAppointments page is captured with no appointments
      ...
      And the AppointmentSlot_NonPhone page is saved to disk
    ...
    Scenario: The appointment cancellation page is captured
      ...
      And the CancelAppointments page is saved to disk
      ...
      And the CancelConfirmation page is saved to disk
    ...
    Scenario: The appointment booking pages are captured
      ...
      Then the Appointment Slot page is displayed
      And the AppointmentSlot_Telephone page is saved to disk
      ...
      And the BookingConfirmation page is saved to disk
