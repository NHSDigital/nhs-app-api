...
@organ-donation-accessibility
  Feature: Organ donation accessibility
    ...
    Scenario: The organ donation journey pages are captured
      ...
      And the OrganDonationYourChoice page is saved to disk
      ...
      And the OrganDonationSpecificOrganChoice page is saved to disk
      When I choose which organs to donate
      And I click the 'Continue' button
      Then the Organ Donation Faith And Beliefs page is displayed
      And the OrganDonationFaithAndBeliefs page is saved to disk
      ...
      And the OrganDonationAdditionalDetails page is saved to disk
      When I click the 'Continue' button
      Then the Organ Donation Check Details page is displayed
      And the OrganDonationCheckDetails page is saved to disk
      ...
      And the OrganDonationViewRegistration page is saved to disk
    ...
    Scenario: The organ donation check details page captured for reaffirm journey
      ...
      Then the Organ Donation Check Details page is displayed
      And the OrganDonationCheckDetails_ReaffirmNoAdditionalDetails page is saved to disk
    ...
    Scenario: The organ donation withdraw journey pages captured
      ...
      And the OrganDonationViewRegistration_ExistingDecision page is saved to disk
      When I choose to withdraw my organ donation decision
      Then the Organ Donation Withdraw Decision page is displayed
      And the OrganDonationWithdrawDecision page is saved to disk
      And I select an organ donation withdrawal reason from the list
      When I click the 'Continue' button
      Then the Organ Donation Check Details page is displayed
      And the OrganDonationCheckDetails_Withdraw page is saved to disk
      ...
      And the OrganDonationViewRegistration_Withdraw page is saved to disk