...
Feature: Clinical Abbreviations Frontend - Medical Record v2
  ...
  Scenario: A patient can navigate to the clinical abbreviations page - Medical Record v2
    ...
    And 'NHS UK' responds to requests for '/abbreviations'
    ...
    And I click the link called 'Help with abbreviations' with a url of 'http://stubs.local.bitraft.io:8080/external/nhsuk/abbreviations'
