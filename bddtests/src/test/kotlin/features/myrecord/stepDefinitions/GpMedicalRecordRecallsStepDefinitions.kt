...
open class GpMedicalRecordRecallsStepDefinitions : AbstractDemographicsStepDefinitions() {

    lateinit var myRecordInfoPage: MyRecordInfoPage
    lateinit var recallsPage: RecallsPage
    ...
    fun thenISeeExpectedRecallsRecordGpMedicalRecord() {
        ...
        recallMessages.forEachIndexed { i, message ->
            Assert.assertEquals(expectedData.get(i), message.text) }
    }
}