...
class ServiceJourneyRulesConfiguration {
    val journey: String = ""
    val value: String = ""
    ...
    fun toJourneyType(): SJRJourneyType {
        ...
        Assert.assertTrue(
                "Test setup incorrect, journey `$journey` does not contain value for `$value`",
                enumValues<SJRJourneyType>().any { it.name == journeyType })
