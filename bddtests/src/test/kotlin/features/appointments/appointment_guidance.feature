...
Feature: Guidance prior to booking an appointment
  ...
  Scenario: A user with upcoming appointments and javascript disabled is presented with guidance
    Given I have upcoming appointments before cutoff time for EMIS
    And I am logged in as a EMIS user
  ...
  Scenario: A user with no upcoming appointments and javascript disabled is presented with guidance
