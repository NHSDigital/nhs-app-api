@symptoms
Feature: Access Symptoms Checker

  Scenario: A user can use the symptoms checker to navigate to advice about coronavirus
  ...
  Scenario: A user can use the symptoms checker to navigate to the Health A to Z
  ...
  Scenario: A user can use the symptoms checker to navigate to 111 online
