...
class GpAtHandStepDefinitions {
    ...
    lateinit var gpAtHandAppointmentsPage: GpAtHandAppointmentsPage
    lateinit var gpAtHandMedicalRecordPage: GpAtHandMedicalRecordPage
    lateinit var gpAtHandPrescriptions : GpAtHandPrescriptionsPage
    ...
    fun iSeeAnAppropriateMessageInformingMeThatMyGpSurgeryUsesTheBabylonAppForAppointments() {
        ...
        gpAtHandAppointmentsPage.assertGpAtHandAppointmentsPageVisible()
    }
    ...
    fun iSeeAnAppropriateMessageInformingMeThatMyGpSurgeryUsesTheBabylonAppForMedicalRecord() {
        ...
        gpAtHandMedicalRecordPage.assertGpAtHandMedicalRecordPageVisible()
    }
    ...
    fun iSeeAnAppropriateMessageInformingMeThatMyGpSurgeryUsesTheBabylonAppForPrescriptions() {
        ...
        gpAtHandPrescriptions.assertGpAtHandPrescriptionsPageVisible()
    }
}