...
Feature: Hospital Appointments
  ...
  Scenario: A user with correct permissions can navigate to the ers hospital appointments page
    ...
    When I click the link called 'Book or cancel your referral appointment' with a url of 'http://web.local.bitraft.io:3000/redirector?redirect_to=http%3A%2F%2Fsilver.local.bitraft.io%3A5001%2Fnhslogin'
