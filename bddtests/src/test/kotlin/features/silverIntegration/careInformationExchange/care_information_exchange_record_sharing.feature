...
@patientsKnowBest
@sharedlinks
Feature: Care Information Exchange Record Sharing
  ...
  Scenario: A user navigates to CIE Record Sharing and sees the warning message
    Given I am using the native app user agent
    And I am a user who can view Record Sharing from Care Information Exchange
    And I am logged in
    ...
    And the record sharing warning on the page explains the service is from Care Information Exchange

  Scenario: A user without access to CIE cannot see the menu item 'Record Sharing' on the health record hub page
    Given I am a user who cannot view Record Sharing from Care Information Exchange
    And I am logged in
    When I navigate to the Health Record Hub page
    Then I see the health records hub page
    And the link to CIE record sharing is not available on the health record hub page
