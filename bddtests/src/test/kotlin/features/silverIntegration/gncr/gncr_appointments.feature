...
Feature: Great North Care Record Appointments
  ...
  Scenario: A user can follow the link to Find out more about personal health records
    ...
    And I am logged in
    When I navigate to the redirector page with a url of '/redirector?redirect_to=https%3A%2F%2Fpepfront.enigmahost.net%2Fappointment'
    Then I am redirected to the redirector page with the header 'Hospital and other appointments'
  ...
  Scenario: A user navigates directly to an external partner site and will see a warning page
    ...
    When I navigate to the redirector page with a url of '/redirector?redirect_to=https%3A%2F%2Fpepfront.enigmahost.net%2Fappointment'
    Then I am redirected to the redirector page with the header 'Hospital and other appointments'
    When I click the 'Continue' button on the redirector page with a url starting with 'https://pepfront.enigmahost.net/appointment'
