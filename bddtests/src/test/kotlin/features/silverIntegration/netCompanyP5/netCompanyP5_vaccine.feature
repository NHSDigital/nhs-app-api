...
Feature: Net Company P5 Vaccine
  ...
  Scenario: A proof level 5 user without access to Net Company Vaccine Record cannot see the menu item 'NHS COVID Pass' on the Home page
  ...
  Scenario: A proof level 5 user with access to Net Company Vaccine Record can navigate to Covid Status for events
    ...
    And I am logged in
    When I click the NHS COVID Pass menu link
