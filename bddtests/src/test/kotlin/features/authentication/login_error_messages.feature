...
#400
  ...
  Scenario: CitizenID provides invalid data after successful login
    ...
    And I see the error 'Contact us' link with a url of 'http://stubs.local.bitraft.io:8080/external/nhsuk/nhs-app-contact-us?errorcode=3a'
...
#504 timeout
  Scenario: Cannot log in as a EMIS when the request timeout I see error code with "zn" prefix
    ...
    When I click the error 'Contact us' link with a url of 'http://stubs.local.bitraft.io:8080/external/nhsuk/nhs-app-contact-us?errorcode=zn'
    Then a new tab has been opened by the link
