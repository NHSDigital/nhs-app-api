...
Feature: Authorisation occurs during each URL visit
  ...
  Scenario: A User who has not logged in yet cannot reach the logout page
    Given I am a EMIS patient who has not already accepted terms and conditions
    And I am not logged in
    And I browse to the /logout and see the login page
    Then I am on the relevant /login page
