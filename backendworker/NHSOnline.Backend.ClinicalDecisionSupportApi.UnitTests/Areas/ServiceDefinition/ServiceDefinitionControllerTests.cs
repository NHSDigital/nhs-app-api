...
using Moq;
using NHSOnline.Backend.ClinicalDecisionSupportApi.Areas.ServiceDefinition;
...
namespace NHSOnline.Backend.ClinicalDecisionSupportApi.UnitTests.Areas.ServiceDefinition
{
    [TestClass]
