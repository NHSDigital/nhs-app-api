...
namespace NHSOnline.Backend.PfsApi.Areas.Messages
{
    public class PatientMessageRecipientsResultAuditingVisitor : IPatientMessageRecipientsResultVisitor<Task>
    {
        ...
        public async Task Visit(GetPatientMessageRecipientsResult.Success result)
        {
            try
            {
                await _auditor.Audit(AuditType, "Patient message recipients successfully retrieved");
            }
            catch (Exception e)
            {
        ...
        public async Task Visit(GetPatientMessageRecipientsResult.BadGateway result)
        {
            try
            {
                await _auditor.Audit(AuditType, "Error retrieving patient message recipients: Bad Gateway");
            }
            catch (Exception e)
            {
        ...
        public async Task Visit(GetPatientMessageRecipientsResult.Forbidden result)
        {
            try
            {
                await _auditor.Audit(AuditType, "Error retrieving patient message recipients: Forbidden");
            }
            catch (Exception e)
            {
        ...
        public async Task Visit(GetPatientMessageRecipientsResult.BadRequest result)
        {
            try
            {
                await _auditor.Audit(AuditType, "Error retrieving patient message recipients: Bad Request");
            }
            catch (Exception e)
            {
        ...
        public async Task Visit(GetPatientMessageRecipientsResult.InternalServerError result)
        {
            try
            {
                await _auditor.Audit(AuditType, "Error retrieving patient message recipients: Internal Server Error");
            }
            catch (Exception e)
            {
