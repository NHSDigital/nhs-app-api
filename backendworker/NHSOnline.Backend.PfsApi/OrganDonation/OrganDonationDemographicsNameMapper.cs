...
{
    internal class OrganDonationDemographicsNameMapper : IMapper<string, DemographicsName, Models.Name>
    {
        private readonly IDictionary<string,string> _titlesMap;
        private const char SpaceChar = ' ';

        public OrganDonationDemographicsNameMapper(IOrganDonationDataMaps dataMaps)
        {
