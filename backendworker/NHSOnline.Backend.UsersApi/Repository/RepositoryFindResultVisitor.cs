...
{
    internal class RepositoryFindResultVisitor : IRepositoryFindResultVisitor<UserDevice, SearchDeviceResult>
    {
        ...
        {
            return new SearchDeviceResult.FoundMany(result.Records);
        }
    }
}