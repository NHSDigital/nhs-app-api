...
namespace NHSOnline.Backend.UsersApi.UnitTests.Notifications
{
    ...
    public class NhsLoginIdServiceTests
    {
        ...
        [TestMethod]
        public void WrapperService_CharactersIsBlank_ThrowsError()
        {
            Assert.ThrowsException<ArgumentNullException>(() => _systemUnderTest = new NhsLoginIdService(string.Empty));
        }
