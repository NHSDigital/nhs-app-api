...
namespace NHSOnline.Backend.ServiceJourneyRulesApi.UnitTests.RuleConfiguration.Utils.Json
{
    ...
    public class SchemaValidatorTests
    {
        ...
        [DataRow("\"cdssAdvice\": { \"provider\": \"eConsult\", \"serviceDefinition\": \"foo\", \"knownGeneralServiceDefinitions\": [\"bar\"] }", DisplayName = "Valid configuration: cdssAdvice provider = eConsult")]
        [DataRow("\"cdssAdmin\": { \"provider\": \"none\" }", DisplayName = "Valid configuration: cdssAdmin provider = none")]
        [DataRow("\"cdssAdmin\": { \"provider\": \"eConsult\", \"serviceDefinition\": \"foo\" , \"knownGeneralServiceDefinitions\": [\"bar\"] }", DisplayName = "Valid configuration: cdssAdmin provider = eConsult")]
        ...
        [DataRow("cdssAdvice", "{\"provider\": \"eConsult\", \"serviceDefinition\": \"foo\"}","PropertyRequired: #/journeys.cdssAdvice.knownGeneralServiceDefinitions", true)]
        ...
        [DataRow("cdssAdmin", "{\"provider\": \"eConsult\", \"serviceDefinition\": \"foo\"}","PropertyRequired: #/journeys.cdssAdmin.knownGeneralServiceDefinitions", true)]
