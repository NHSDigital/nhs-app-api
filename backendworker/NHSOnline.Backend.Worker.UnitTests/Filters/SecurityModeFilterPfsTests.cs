...
{
    [TestClass]
    public class SecurityModeFilterPfsTest
    {
        ...
        public void TestInitialize()
        {
            ...
            _configuration.SetupGet(x => x["runMode"]).Returns("pfs");
        ...
        {
            Assert.AreEqual(RunMode.Pfs, _pfsSecurityModeAttribute.SecurityMode);
        }

        [TestMethod]
        public void FilterTest_LoadPfsEndPoint_PfsParam()
        {
        ...
        [TestMethod]
        public void FilterTest_LoadCidEndPoint_PfsParam()
        {
