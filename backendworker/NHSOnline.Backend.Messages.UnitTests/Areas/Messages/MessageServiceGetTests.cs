...
namespace NHSOnline.Backend.Messages.UnitTests.Areas.Messages
{
    ...
    public class MessageServiceGetTests
    {
        ...
        [TestMethod]
        public async Task GetSenders_WhenRepositoryReturnsMessageForUser_ReturnsFoundResultGroupedBySenderId()
        {
            // Arrange
            _mockMessageRepository
                .Setup(x => x.FindAllForUser(NhsLoginId))
        ...
        [TestMethod]
        public async Task GetSenders_WhenRepositoryReturnsNotFound_ReturnsNone()
        {
            // Arrange
            _mockMessageRepository
                .Setup(x => x.FindAllForUser(NhsLoginId))
        ...
        [TestMethod]
        public async Task GetSenders_WhenRepositoryThrowsException_ReturnsInternalServerError()
        {
            // Arrange
            _mockMessageRepository
                .Setup(x => x.FindAllForUser(NhsLoginId))
        ...
        [TestMethod]
        public async Task GetSenders_WhenRepositoryReturnsError_ReturnsBadGatewayError()
        {
            // Arrange
            _mockMessageRepository
                .Setup(x => x.FindAllForUser(NhsLoginId))
