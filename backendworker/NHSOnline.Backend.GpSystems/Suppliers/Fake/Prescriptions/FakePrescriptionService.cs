    ...
    public class FakePrescriptionService : FakeServiceBase, IPrescriptionService
    {
            ...
            DateTimeOffset? fromDate = null,  DateTimeOffset? toDate = null)
        {
            try
            {
                ...
                return await fakeUser.PrescriptionBehaviour.GetPrescriptions(gpLinkedAccountModel, fromDate, toDate);
            }
            catch (Exception e)
            {
            ...
            RepeatPrescriptionRequest repeatPrescriptionRequest)
        {
            ...
            {
                var fakeUser = FindUser(gpLinkedAccountModel);
                return await fakeUser.PrescriptionBehaviour.OrderPrescription(gpLinkedAccountModel,
