...
{
    public class UserAndInfoRepositoryByOdsCodeConfiguration : ISqlApiRepositoryConfiguration
    {
        public string DatabaseName { get; private set; }
        public string ContainerName { get; private set; }

        public UserAndInfoRepositoryByOdsCodeConfiguration(
            IConfiguration configuration,
            ILogger<UserAndInfoRepositoryByOdsCodeConfiguration> logger)
        {
            DatabaseName = configuration.GetOrThrow("COMMS_SQL_API_DATABASE_NAME", logger);
            ContainerName = configuration.GetOrThrow("USERINFO_ODS_CODE_CONTAINER", logger);
        }
