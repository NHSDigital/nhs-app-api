...
{
    public class TppLinkageRequestValidationService : ILinkageRequestValidationService
    {
        private readonly ILogger<TppLinkageRequestValidationService> _logger;

        public TppLinkageRequestValidationService(ILogger<TppLinkageRequestValidationService> logger)
        {
            _logger = logger;
        }
