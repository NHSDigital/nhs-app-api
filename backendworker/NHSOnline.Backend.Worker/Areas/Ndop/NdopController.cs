    ...
    public class NdopController : Controller
    {
        ...
        public async Task<IActionResult> GetToken()
        {
            try
            {
                ...
                _auditor.Audit(Constants.AuditingTitles.GetNdopTokenAuditTypeRequest, "Getting Ndop JWT Token");

                var result = await _ndopService.GetJwtToken(userSession.NhsNumber);
