...
namespace NHSOnline.Backend.Auditing.UnitTests
{
    ...
    public sealed class AuditorTests : IDisposable
    {
        ...
        private static string referrerOrigin = "";
        ...
        private class DummyClassThatAudits
        {
                ...
                )
            {
                ...
                using (_auditor.BeginScope(dummyContext))
                {
                    await _auditor.PostOperationAuditSessionEvent(accessToken, nhsNumber, supplier, operation, details, referrer, integrationReferrer, referrerOrigin, parameters);
                }
            }
        ...
        public void TestInitialize()
        {
            ...
            {
                new KeyValuePair<string, string>(Constants.EnvironmentalVariables.VersionTag, "UNIT TEST"),
                new KeyValuePair<string, string>("ENVIRONMENT_NAME", "TEST")
            });
        ...
        {
            var userSession = CreateUserSession(_nhsNumber1, accessToken, _odsCode);
        ...
        {
            var userSession = CreateUserSessionNoGpSystem(_nhsNumber1, accessToken, _odsCode);
        ...
        {
            var userSession = CreateUserSession(_nhsNumber1, AuditorTestResources.AccessTokenInvalid, _odsCode);
        ...
        {
            var userSession = CreateUserSessionNoGpSystem(_nhsNumber1, AuditorTestResources.AccessTokenInvalid, _odsCode);
