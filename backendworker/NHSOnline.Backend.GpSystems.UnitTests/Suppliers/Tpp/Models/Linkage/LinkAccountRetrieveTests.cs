...
{
    [TestClass]
    public class LinkAccountRetrieveTests : XmlTestBase<LinkAccountRetrieve>
    {
        ...
        protected override LinkAccountRetrieve CreateModel() => new LinkAccountRetrieve
        {
        ...
        [TestMethod]
        public void Serialization_RetrieveOnly_SerializesAsAttribute()
        {
            Element.Attribute("retrieveOnly").Should().HaveValue("y");
        }
