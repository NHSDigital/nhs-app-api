...
namespace NHSOnline.Backend.GpSystems.UnitTests.Suppliers.Emis.Appointments
{
    ...
    public class AppointmentsMapperTests
    {
        ...
        public void Map_ReturnsNoLocation_WhenLocationsInResponseIsNull()
        {
            ...
            var appointment =
                CreateAppointment(101, 1, DateTimeHelper.DateTimeToJson(_tomorrow), DateTimeHelper.DateTimeToJson(_tomorrow), "Emergency");
        ...
        public void Map_ReturnsResponseWithoutSlot_WhenStartTimeInAppointmentIsInInvalidFormat(string invalidStartTime)
        {
            ...
            var appointment2 =
                CreateAppointment(901, 9, DateTimeHelper.DateTimeToJson(_tomorrow.AddDays(1)), DateTimeHelper.DateTimeToJson(_tomorrow.AddDays(1)), "Emergency");
        ...
        public void Map_HappyPath_ReturnsAnEnumerableOfPastAndUpcomingAppointments()
        {
            // Arrange
            var appointment1 =
                CreateAppointment(101, 1, DateTimeHelper.DateTimeToJson(_tomorrow.AddDays(1)), DateTimeHelper.DateTimeToJson(_tomorrow.AddDays(1)), "Emergency");
            
            var appointment2=
                CreateAppointment(901, 9, DateTimeHelper.DateTimeToJson(_tomorrow), DateTimeHelper.DateTimeToJson(_tomorrow), "Emergency");

            var appointment3 =
                CreateAppointment(102, 9, DateTimeHelper.DateTimeToJson(_tomorrow.AddMonths(1)), DateTimeHelper.DateTimeToJson(_tomorrow.AddMonths(1)), null);
            
            var appointment4 =
                CreateAppointment(103, 1, DateTimeHelper.DateTimeToJson(_tomorrow.AddDays(-1)), DateTimeHelper.DateTimeToJson(_tomorrow.AddDays(-1)), "Emergency");

            var appointment5 =
                CreateAppointment(104, 9, DateTimeHelper.DateTimeToJson(_tomorrow.AddMonths(-1)), DateTimeHelper.DateTimeToJson(_tomorrow.AddMonths(-1)), null);
