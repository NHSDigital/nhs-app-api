...
namespace NHSOnline.Backend.GpSystems.UnitTests.Suppliers.Emis.PatientRecord
{
    ...
    public class EmisProblemMapperTests
    {
        ...
        public void MapProblemRequestsGetResponseToProblemListResponse_WithEmptyValues_ReturnsResultWithEmptyValues()
        {
            ...
            // Act
            var result = _mapper.Map(new Allergies(), new Medications(), new Immunisations(), new TestResults(), new EmisProblemMapper().Map(item), new Consultations(), new PatientDocuments());
