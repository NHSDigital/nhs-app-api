...
namespace NHSOnline.Backend.GpSystems.UnitTests.SessionManager
{
    ...
    public class GpSessionManagerTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _userProfile = new UserProfile(userInfo, _fixture.Create<string>(), _fixture.Create<string>(), _fixture.Create<string>());
            ...
            _userSession = new P9UserSession(_csrfToken, _userProfile.NhsNumber, citizenIdUserSession, _userProfile.Im1ConnectionToken, emisUserSession);
