...
namespace NHSOnline.Backend.Support.UnitTests
{
    ...
    public sealed class ErrorReferenceGeneratorTests: IDisposable
    {
        ...
        [DataRow(typeof(ErrorTypes.LoginOdsCodeNotSupported), "3f")]
        [DataRow(typeof(ErrorTypes.LoginOdsCodeNotFound), "3r")]
        [DataRow(typeof(ErrorTypes.LoginNhsNumberNotFound), "3u")]
        ...
        [DataRow(ErrorCategory.Login, 468, "3r")]
        [DataRow(ErrorCategory.Login, 469, "3u")]
