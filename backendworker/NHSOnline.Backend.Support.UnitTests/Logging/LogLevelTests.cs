...
namespace NHSOnline.Backend.Support.UnitTests.Logging
{
    ...
    public sealed class LogLevelTests : IDisposable
    {
        ...
        {
            var logProvider = new NhsAppLoggerProvider(new StreamWriter(_stream), logLevel);
        ...
        public void LogRange()
        {
            ...
            var streamReader = Log(new NhsAppLoggerProvider(new StreamWriter(_stream), LogLevel.Debug, LogLevel.Error));
