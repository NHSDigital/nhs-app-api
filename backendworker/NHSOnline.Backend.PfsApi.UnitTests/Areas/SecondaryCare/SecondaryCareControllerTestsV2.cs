...
{
    [TestClass]
    public sealed class SecondaryCareControllerTestsV2
    {
        ...
        [TestMethod]
        public async Task WhenOAuthTokenResponseFromAPIMIsUnsuccessfulThenGetSummaryV2Returns502BadGateway()
        {
            // Arrange APIM
            Context.MockNhsApimHttpClientGetTokenReturnsUnsuccessfulResponse();

            // Act
            var result = await Context.CreateSystemUnderTest().GetSummaryV2(Context.Data.P9UserSession);
        ...
        [TestMethod]
        public async Task WhenGetSummaryResponseFromClientIsSuccessfulThenGetSummaryV2Returns200WithCompleteOrderedSummaryResponse()
        {
            // Arrange
            ...
            // Assert
            result.Should().BeAssignableTo<OkObjectResult>().Subject.Value.Should().BeEquivalentTo(Context.Data.SummaryResponseV2);
        ...
        [TestMethod]
        public async Task WhenGetSummaryResponseFromClientIsUnsuccessfulThenGetSummaryV2Returns502BadGateway()
        {
            // Arrange
            Context.MockNhsApimHttpClientGetTokenReturnsSuccessfulResponseWithAuthToken();
        ...
        [TestMethod]
        public async Task WhenGetSummaryResponseFromClientTimesOutThenGetSummaryV2Returns504GatewayTimeout()
        {
            // Arrange
            Context.MockNhsApimHttpClientGetTokenReturnsSuccessfulResponseWithAuthToken();
        ...
        [TestMethod]
        public async Task WhenGetSummaryResponseFromClientIsForbiddenWithMinimumAgeReasonThenGetSummaryV2Returns470()
        {
            // Arrange
            Context.MockNhsApimHttpClientGetTokenReturnsSuccessfulResponseWithAuthToken();
        ...
        public async Task WhenGetSummaryResponseFromClientHasMissingOrInvalidDataThenGetSummaryV2LogsErrorsAndReturns502(
            string response,
