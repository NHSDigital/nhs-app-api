    ...
    public class SupplierStartupTests
    {
        ...
        public void ConfigureServices_SetsUpCorrectServicesForDependencyInjection_WhenEmisIsEnabled()
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableEmis == true)))
                .Verifiable();
        ...
        public void ConfigureServices_SetsUpCorrectServicesForDependencyInjection_WhenVisinoIsEnabled()
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableVision == true)))
                .Verifiable();
        ...
        public void ConfigureServices_DoesntSetupVisionServicesForDependencyInjection_WhenVisionIsDisabled(string value)
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableVision == false)))
                .Verifiable();
        ...
        public void ConfigureServices_SetsUpCorrectServicesForDependencyInjection_WhenTppIsEnabled()
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableTpp == true)))
                .Verifiable();
        ...
        public void ConfigureServices_DoesntSetupEmisServicesForDependencyInjection_WhenTppIsDisabled(string value)
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableTpp == false)))
                .Verifiable();
        ...
        public void ConfigureServices_SetsUpCorrectServicesForDependencyInjection_WhenMicrotestIsEnabled()
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableMicrotest == true)))
                .Verifiable();
