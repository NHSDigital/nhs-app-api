...
namespace NHSOnline.Backend.PfsApi.UnitTests.DependencyInjection
{
    ...
    public class SupplierStartupTests
    {
        ...
        public void ConfigureServices_SetsUpCorrectServicesForDependencyInjection_WhenVisionIsEnabled()
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableVision)))
                .Verifiable();
        ...
        public void ConfigureServices_SetsUpCorrectServicesForDependencyInjection_WhenTppIsEnabled()
        {
            ...
            _gpSystemRegistrationService
                .Setup(x => x.RegisterPfsServices(serviceCollection, It.Is<EnableGpSupplierConfiguration>(config => config.EnableTpp)))
                .Verifiable();
