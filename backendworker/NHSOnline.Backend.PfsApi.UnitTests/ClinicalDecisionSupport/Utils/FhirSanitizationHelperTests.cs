...
namespace NHSOnline.Backend.PfsApi.UnitTests.ClinicalDecisionSupport.Utils
{
    ...
    public class FhirSanitizationHelperTests
    {
        ...
        {
            // Arrange
            var fhirParser = new STU3Serialization.FhirJsonParser();
            var parsedGuidanceResponse = (STU3Models.GuidanceResponse) fhirParser.Parse(GuidanceResponse);
            ...
            var questionnaire = (STU3Models.Questionnaire) contained[0];
        ...
        public void Validate_DecodeGuidanceResponse_CarePlanText()
        {
            // Arrange
            var fhirParser = new STU3Serialization.FhirJsonParser();
            var parsedGuidanceResponse = (STU3Models.GuidanceResponse) fhirParser.Parse(GuidanceResponseWithResult);
            ...
            // Assert
            var contained = parsedGuidanceResponse.Contained;
            var carePlan = (STU3Models.CarePlan) contained[1];
        ...
        public void Validate_DecodeGuidanceResponse_ReferralRequestText()
        {
            ...
            // Assert
            var contained = parsedGuidanceResponse.Contained;
            var referralRequest = (STU3Models.ReferralRequest) contained[2];
        ...
        public void Validate_DecodeGuidanceResponse_OptionValue()
        {
            // Arrange
            var fhirParser = new STU3Serialization.FhirJsonParser();
            var parsedGuidanceResponse = (STU3Models.GuidanceResponse) fhirParser.Parse(GuidanceResponseOptions);
            ...
            // Assert
            var contained = parsedGuidanceResponse.Contained;
            var questionnaire = (STU3Models.Questionnaire) contained[1];
