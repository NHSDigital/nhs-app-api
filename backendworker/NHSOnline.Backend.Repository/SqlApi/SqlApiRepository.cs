...
namespace NHSOnline.Backend.Repository.SqlApi
{
        ...
        where TRecord: RepositoryRecord
    {
        ...
        public async Task<RepositoryCreateResult<TRecord>> CreateOrUpdate(TRecord record, string recordName, string partitionKeyValue)
        {
            try
            {
            ...
            {
                _logger.LogError(nullException, $"Cosmos Sql Api Failure due to null value. Create or update {recordName}.");
                return new RepositoryCreateResult<TRecord>.RepositoryError();
            }
        ...
        public async Task<RepositoryDeleteResult<TRecord>> Delete(string id, string partitionKeyValue, string recordName)
        {
            try
            {
        ...
        private async Task<ItemResponse<TRecord>> CreateOrUpdateRecord(TRecord record, string recordName, string partitionKeyValue)
        {
