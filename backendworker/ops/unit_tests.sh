...
docker run \
  ...
  /bin/bash -c "  \
    ...
    dotnet ~/.nuget/packages/reportgenerator/4.1.8/tools/netcoreapp2.1/ReportGenerator.dll '-reports:**/coverage/coverage.opencover.xml' '-targetdir:coverage' '-reportTypes:HTML;Cobertura' ; \
