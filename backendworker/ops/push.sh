...
APIS=(backendpfsapi backendcidapi backendservicejourneyrulesapi backendclinicaldecisionsupportapi backendcdsswiremock backendusersapi backendmessagesapi clientloggerapi)
