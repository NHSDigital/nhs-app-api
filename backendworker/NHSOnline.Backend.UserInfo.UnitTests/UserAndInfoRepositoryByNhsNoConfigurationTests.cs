...
{
    [TestClass]
    public class UserAndInfoRepositoryByNhsNoConfigurationTests
    {
        ...
        public void Validate_WhenConfigValuesAreValid_ShouldSuccess()
        {
            ...
            // Act
            var config = new UserAndInfoRepositoryByNhsNoConfiguration(_mockConfiguration.Object,
                new Mock<ILogger<UserAndInfoRepositoryByNhsNoConfiguration>>().Object);
            config.Validate();
        ...
        public void Validate_WhenDatabaseNameInvalid_ThrowsException(string value)
        {
            ...
            // Act
            Action act = () => new UserAndInfoRepositoryByNhsNoConfiguration(_mockConfiguration.Object,
                new Mock<ILogger<UserAndInfoRepositoryByNhsNoConfiguration>>().Object).Validate();
