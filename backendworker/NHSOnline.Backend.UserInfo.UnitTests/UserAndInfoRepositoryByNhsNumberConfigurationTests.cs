...
{
    [TestClass]
    public class UserAndInfoRepositoryByNhsNumberConfigurationTests
    {
        private Mock<IConfiguration> _mockConfiguration;

        private const string DatabaseKey = "COMMS_SQL_API_DATABASE_NAME";
        private const string CollectionKey = "USERINFO_NHS_NUMBER_CONTAINER";
        ...
        public void Validate_WhenConfigValuesAreValid_ShouldSuccess()
        {
            ...
            // Act
            var config = new UserAndInfoRepositoryByNhsNumberConfiguration(_mockConfiguration.Object,
                new Mock<ILogger<UserAndInfoRepositoryByNhsNumberConfiguration>>().Object);
            config.Validate();
        ...
        public void Validate_WhenDatabaseNameInvalid_ThrowsException(string value)
        {
            ...
            // Act
            Action act = () => new UserAndInfoRepositoryByNhsNumberConfiguration(_mockConfiguration.Object,
                new Mock<ILogger<UserAndInfoRepositoryByNhsNumberConfiguration>>().Object).Validate();
