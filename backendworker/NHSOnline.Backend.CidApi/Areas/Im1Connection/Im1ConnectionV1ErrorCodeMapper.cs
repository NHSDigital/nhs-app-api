    ...
    internal static class Im1ConnectionV1ErrorCodeMapper
    {
        ...
        private static readonly Dictionary<InternalCode, int> ErrorCodeToStatusCode =
            new Dictionary<InternalCode, int>
            {
                ...
                { InternalCode.PatientOnSystemOneNotMatchedToARecordOnPDS, StatusCodes.Status404NotFound },
                { InternalCode.IncompleteOrEndedPFSRegistrationDetails, StatusCodes.Status404NotFound },
                { InternalCode.ProvidedLastNameDoesNotMatchSystmOne, StatusCodes.Status404NotFound },
                { InternalCode.ProvidedDOBDoesNotMatchSystmOne, StatusCodes.Status404NotFound },
                { InternalCode.PatientIsNotOldEnoughToSignUp, StatusCodes.Status404NotFound },
                { InternalCode.NoPatientWithNhsNumberExistsOnSystmOne, StatusCodes.Status404NotFound },
                { InternalCode.PatientNotRegisteredAtPracticeSpecifiedByOrgCode, StatusCodes.Status404NotFound },
                { InternalCode.ErrorCreatingNewPFSAccountAndLinkageKeys, StatusCodes.Status404NotFound },
