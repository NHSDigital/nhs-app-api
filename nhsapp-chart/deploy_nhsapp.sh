...
DEFAULT_IMAGE_TAG="${DEFAULT_IMAGE_TAG:-$COMMIT_ID}"
API_IMAGE_TAG=${API_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
CID_IMAGE_TAG=${CID_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
WEB_IMAGE_TAG=${WEB_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
SJR_IMAGE_TAG=${SJR_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
SJRCONFIG_IMAGE_TAG=${SJRCONFIG_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
LOGGER_IMAGE_TAG=${LOGGER_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
USERS_IMAGE_TAG=${USERS_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
MESSAGES_IMAGE_TAG=${MESSAGES_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
INFO_IMAGE_TAG=${INFO_IMAGE_TAG:-$DEFAULT_IMAGE_TAG}
...
[ -n "$ENVIRONMENT_OVERRIDE_NHSLOGIN" ] && {
	info "Overriding NHS login environment using $ENVIRONMENT_OVERRIDE_NHSLOGIN"
	ENVIRONMENT_OVERRIDE_NHSLOGIN_FILE="../vars/zone/$TARGET_ZONE/environment_overrides/vars-nhslogin-${ENVIRONMENT_OVERRIDE_NHSLOGIN}.yaml"
	[ -f "$ENVIRONMENT_OVERRIDE_NHSLOGIN_FILE" ] || {
		die "Environment override file $ENVIRONMENT_OVERRIDE_NHSLOGIN_FILE not found"
	}
	CUSTOM_VALUES=$CUSTOM_VALUES" -f $ENVIRONMENT_OVERRIDE_NHSLOGIN_FILE";
}
