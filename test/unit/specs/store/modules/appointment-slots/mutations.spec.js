...
describe('SLOT_SELECTED', () => {
  it('will set the selected slot to the slot with received ID', () => {
    ...
    mutations[SLOT_SELECTED](state, '1');
...
describe('SLOTS_LOADED', () => {
  it('will set the appointment sessions on the state from the received slot data', () => {
    ...
    mutations[SLOTS_LOADED](state, receivedData);
  ...
  it('will order the appointment slots by first clinician name when start times are the same', () => {
    ...
    const receivedData = {
      slots: [
        { id: '3', startTime: '2018-04-22T17:11:59.084865+01:00', clinicianIds: ['4', '2'] },
        { id: '2', startTime: '2018-04-22T17:11:59.084865+01:00', clinicianIds: ['1', '4'] },
        { id: '1', startTime: '2018-04-21T17:11:59.084865+01:00', clinicianIds: ['2'] },
        { id: '4', startTime: '2018-04-22T17:11:59.084865+01:00', clinicianIds: ['3', '1'] },
      ],
      clinicians,
    };
