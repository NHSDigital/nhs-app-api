...
class BiometricStringHandler {
    ...
    func getControllerStrings() -> BiometricControllerStrings {
        return BiometricControllerStrings(getBiometricType())
    }
    
    func getErrorStrings() -> BiometricErrorStrings {
        return BiometricErrorStrings(getBiometricType())
    }
    
    func getResultStrings(isRegistration: Bool) -> BiometricResultStrings {
        return BiometricResultStrings(getBiometricType(), isRegistration)
    }
}
