...
struct Config: Decodable {
    ...
    let LoggerApiPath: String

    let MyRecordUrlPath: String
    let HealthRecordsUrlPath: String
    let MyRecordGpAtHandUrlPath: String
    let MessagesUrlPath: String
