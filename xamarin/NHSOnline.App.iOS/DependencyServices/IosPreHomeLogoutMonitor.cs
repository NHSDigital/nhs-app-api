...
[assembly: Dependency(typeof(IosPreHomeLogoutMonitor))]
namespace NHSOnline.App.iOS.DependencyServices
{
    internal class IosPreHomeLogoutMonitor: IPreHomeLogoutMonitor
    {
        private readonly ILogger _logger = NhsAppLogging.CreateLogger<IosPreHomeLogoutMonitor>();
        ...
        public void Finish(Uri? finalUrl)
        {
            ...
            _logger.LogError($"Pre-home journey logged out unexpectedly. Navigated to urls: {urlLogs}");
        }
