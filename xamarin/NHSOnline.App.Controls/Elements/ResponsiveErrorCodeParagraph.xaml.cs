...
namespace NHSOnline.App.Controls.Elements
{
    ...
    public partial class ResponsiveErrorCodeParagraph
    {
        ...
        public static readonly BindableProperty LeadInTextProperty =
            BindableProperty.Create(nameof(LeadInText), typeof(string), typeof(ResponsiveErrorCodeParagraph));

        public static readonly BindableProperty BoldTextProperty =
            BindableProperty.Create(nameof(BoldText), typeof(string), typeof(ResponsiveErrorCodeParagraph));

        public static readonly BindableProperty AccessibleBoldTextLabelProperty =
            BindableProperty.Create(nameof(AccessibleBoldTextLabelProperty), typeof(string), typeof(ResponsiveErrorCodeParagraph));

        public static readonly BindableProperty LeadOutTextProperty =
            BindableProperty.Create(nameof(LeadOutText), typeof(string), typeof(ResponsiveErrorCodeParagraph));

        public ResponsiveErrorCodeParagraph()
        {
            InitializeComponent();
        }
