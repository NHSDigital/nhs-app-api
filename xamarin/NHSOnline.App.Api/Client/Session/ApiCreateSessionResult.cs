...
namespace NHSOnline.App.Api.Client.Session
{
    internal abstract class ApiCreateSessionResult
    {
        ...
        internal sealed class BadResponseFromUpstreamSystem : ApiCreateSessionResult
        {
            public BadResponseFromUpstreamSystem(PfsErrorResponse pfsErrorResponse) => PfsErrorResponse = pfsErrorResponse;
        ...
        internal sealed class UpstreamSystemTimeout : ApiCreateSessionResult
        {
            public UpstreamSystemTimeout(PfsErrorResponse pfsErrorResponse) => PfsErrorResponse = pfsErrorResponse;
