...
namespace NHSOnline.App.Areas.LoggedOut.Views
{
    ...
    public partial class NhsLoginErrorPage : INhsLoginErrorView, INhsLoginErrorView.IEvents
    {
        ...
        public NhsLoginErrorPage(ILogger<NhsLoginErrorPage> logger, IAccessibilityService accessibilityService, INavigationService navigationService): base(accessibilityService)
        {
            _logger = logger;
            _navigationService = navigationService;
            _appNavigation = new AppNavigation<INhsLoginErrorView.IEvents>(this, _navigationService);
