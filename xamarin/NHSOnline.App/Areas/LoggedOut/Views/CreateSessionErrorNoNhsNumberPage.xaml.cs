...
namespace NHSOnline.App.Areas.LoggedOut.Views
{
    ...
    public partial class CreateSessionErrorNoNhsNumberPage : ICreateSessionErrorNoNhsNumberView, ICreateSessionErrorNoNhsNumberView.IEvents
    {
        ...
        public CreateSessionErrorNoNhsNumberPage(ILogger<CreateSessionErrorNoNhsNumberPage> logger, IAccessibilityService accessibilityService, INavigationService navigationService): base(accessibilityService)
        {
            _logger = logger;
            _navigationService = navigationService;
            _appNavigation = new AppNavigation<ICreateSessionErrorNoNhsNumberView.IEvents>(this, _navigationService);
