...
namespace NHSOnline.App.Areas.LoggedOut.Views
{
    ...
    public partial class CreateSessionErrorBadResponseFromUpstreamSystemPage : ICreateSessionErrorBadResponseFromUpstreamSystemView, ICreateSessionErrorBadResponseFromUpstreamSystemView.IEvents
    {
        ...
        public CreateSessionErrorBadResponseFromUpstreamSystemPage(ILogger<CreateSessionErrorBadResponseFromUpstreamSystemPage> logger, IAccessibilityService accessibilityService, INavigationService navigationService): base(accessibilityService)
        {
            _logger = logger;
            _navigationService = navigationService;
            _appNavigation = new AppNavigation<ICreateSessionErrorBadResponseFromUpstreamSystemView.IEvents>(this, _navigationService);
