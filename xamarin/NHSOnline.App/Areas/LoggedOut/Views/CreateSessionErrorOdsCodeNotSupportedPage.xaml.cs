...
namespace NHSOnline.App.Areas.LoggedOut.Views
{
    ...
    public partial class CreateSessionErrorOdsCodeNotSupportedPage : ICreateSessionErrorOdsCodeNotSupportedView, ICreateSessionErrorOdsCodeNotSupportedView.IEvents
    {
        public static readonly BindableProperty ServiceDeskReferenceProperty
            = BindableProperty.Create(nameof(ServiceDeskReference), typeof(string), typeof(CreateSessionErrorOdsCodeNotSupportedPage), "3f");

        private readonly ILogger _logger;
        private readonly AppNavigation<ICreateSessionErrorOdsCodeNotSupportedView.IEvents> _appNavigation;
        private readonly INavigationService _navigationService;

        public CreateSessionErrorOdsCodeNotSupportedPage(ILogger<CreateSessionErrorOdsCodeNotSupportedPage> logger, IAccessibilityService accessibilityService, INavigationService navigationService): base(accessibilityService)
        {
            _logger = logger;
            _navigationService = navigationService;
            _appNavigation = new AppNavigation<ICreateSessionErrorOdsCodeNotSupportedView.IEvents>(this, _navigationService);

            InitializeComponent();
        }

        IAppNavigation<ICreateSessionErrorOdsCodeNotSupportedView.IEvents> INavigationView<ICreateSessionErrorOdsCodeNotSupportedView.IEvents>.AppNavigation => _appNavigation;
        ...
        public Func<Task>? GpOutOfHoursServiceRequested { get; set; }
        public ICommand GpOutOfHoursServiceCommand => new AsyncCommand(() => GpOutOfHoursServiceRequested);
