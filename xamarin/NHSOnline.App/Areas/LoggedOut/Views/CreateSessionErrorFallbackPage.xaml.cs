...
namespace NHSOnline.App.Areas.LoggedOut.Views
{
    ...
    public partial class CreateSessionErrorFallbackPage : ICreateSessionErrorFallbackView, ICreateSessionErrorFallbackView.IEvents
    {
        ...
        public CreateSessionErrorFallbackPage(ILogger<CreateSessionErrorFallbackPage> logger, IAccessibilityService accessibilityService, INavigationService navigationService): base(accessibilityService)
        {
            _logger = logger;
            _navigationService = navigationService;
            _appNavigation = new AppNavigation<ICreateSessionErrorFallbackView.IEvents>(this, _navigationService);
        ...
        {
            _logger.LogInformation("{className} is not required to handle deeplinks", nameof(CreateSessionErrorFallbackPage));
