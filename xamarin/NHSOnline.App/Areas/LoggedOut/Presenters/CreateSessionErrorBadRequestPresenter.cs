...
{
    internal sealed class CreateSessionErrorBadRequestPresenter
    {
        private readonly ICreateSessionErrorBadRequestView _view;
        private readonly CreateSessionErrorBadRequestModel _model;
        private readonly IBrowserOverlay _browserOverlay;
        private readonly INhsExternalServicesConfiguration _externalServicesConfiguration;

        public CreateSessionErrorBadRequestPresenter(
            ICreateSessionErrorBadRequestView view,
            CreateSessionErrorBadRequestModel model,
