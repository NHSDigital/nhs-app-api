...
namespace NHSOnline.App.Areas.WebIntegration.Views
{
    ...
    public partial class WebIntegrationPage : IWebIntegrationView, IWebIntegrationView.IEvents, ISwipeablePage
    {
        ...
        public Func<string, Task>? OpenExternalBrowserRequested { get; set; }
        public AsyncCommand<string> OpenExternalBrowserCommand
            => new AsyncCommand<string>(() => OpenExternalBrowserRequested);
        ...
        public Func<SslErrorDetails, Task>? SslError { get; set; }

        public AsyncCommand<SslErrorDetails> SslErrorCommand
            => new AsyncCommand<SslErrorDetails>(() => SslError);
