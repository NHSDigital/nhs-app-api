...
namespace NHSOnline.App.Config.Values.Local
{
    public class LocalNhsExternalServicesConfiguration: INhsExternalServicesConfiguration
    {
        ...
        public Uri DigitalCovidPassUrl { get; } = new Uri("http://stubs.local.bitraft.io:8080/nhsuk/digitalCovidPass");
        public Uri PaperCovidPassUrl { get; } = new Uri("http://stubs.local.bitraft.io:8080/nhsuk/paperCovidPass");
        ...
        public Uri NhsAppGetDocumentDownloadHelpUrl { get; } = new Uri("http://stubs.local.bitraft.io:8080/nhsuk/help-and-support/health-records-in-the-nhs-app/gp-health-record/");
    }
}
