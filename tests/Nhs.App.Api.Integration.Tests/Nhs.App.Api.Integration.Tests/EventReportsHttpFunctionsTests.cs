...
namespace Nhs.App.Api.Integration.Tests
{
    ...
    public class EventReportsHttpFunctionsTests : CommunicationHttpFunctionBase
    {
        ...
        public async Task EventReportGet_InvalidRequestInvalidPageValue_ReturnsBadRequest(string dayParameter,
            string pageParameter)
        {
            // Arrange
            using var httpClient = CreateHttpClient();
        ...
        [DataRow("2021-01-01", "")]
        public async Task EventReportGet_InvalidRequestNoPageValue_ReturnsBadRequest(string dayParameter,
            string pageParameter)
        {
            // Arrange
            using var httpClient = CreateHttpClient();
